...
private:
    std::shared_ptr<FaunusCache> faunus_cache_;
public:
...
private:
    ...
    // Set/get helpers for per-CS maintenance queues
    ...
    std::vector<std::pair<size_t, KVItem>> get_candidate_kvs(const LeafNode& leaf, const faunus_index_internal::Fingerprint& fp, bool& sucess, bool from_insert=false, bool from_read=false);
