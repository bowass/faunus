// range_bench.cpp
// Compile with:
// g++ -std=c++20 -O2 -pthread -I../externals/skiplist/include ../externals/skiplist/src/skiplist.cc bench.cpp -o bench -g
// Make sure the RangeCache and SlabAllocator headers/implementation are visible to the compiler.
// Expects: RangeCache<int,int> and a SlabAllocator compatible with RangeCache ctor.
...
#include "../kv_index/array_var.hpp"
